...
if($_GET['pid'] == '' || $_GET['addtime'] == ''){
	echo "<script>Daen_confirm('warning','啊哦','请通过应用管理-操作-数据进入<br>即将为您跳转~',true,'plugin_man.php');</script>";
	return;
}
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-primary">
              <div class="card-body clearfix">
                ...
                <div class="pull-left"> <span class="img-avatar img-avatar-48 bg-translucent"><i class="mdi mdi-verified fa-1-5x"></i></span> </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-danger">
              <div class="card-body clearfix">
                ...
                <div class="pull-left"> <span class="img-avatar img-avatar-48 bg-translucent"><i class="mdi mdi-alert-circle fa-1-5x"></i></span> </div>
              </div>
            </div>
          </div>
          ...
          <div class="col-sm-6 col-lg-3">
            <div class="card bg-purple">
              <div class="card-body clearfix">
                ...
                <div class="pull-left"> <span class="img-avatar img-avatar-48 bg-translucent"><i class="mdi mdi-timer fa-1-5x"></i></span> </div>
              </div>
            </div>
          </div>
        </div>
